        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-4">
            ...
            <div className="lg:w-1/4 md:w-1/2 p-4 w-full shadow-sm">
              ...
              <div className="mt-4 text-center md:text-left">
                <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1">T-Shirts</h3>
                <wear className="text-gray-900 title-font text-lg font-medium">Neptune</wear the code
            ...
            <div className="lg:w-1/4 md:w-1/2 p-4 w-full shadow-sm">
              ...
              <div className="mt-4 text-center md:text-left">
                <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1">T-Shirts</h3>
                <h2 className="text-gray-900 title-font text-lg font-medium">The wear the code</h2>
