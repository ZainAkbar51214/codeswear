            ...
            <Link href={'/product/wear-the-code'} className='contents'>
              <div className="lg:w-1/4 md:w-1/2 p-4 w-full shadow-sm">
                <p className="block relative rounded overflow-hidden">
                  <img alt="ecommerce" className="m-auto md:mx-0 h-[30vh] md:h-[36vh] block" src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.daraz.https://m.media-amazon.com/images/I/61vNeA0eciL._AC_SX569_.jpg" />
                </p>
