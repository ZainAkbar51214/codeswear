        ...
        <>
            <nav className={`${globalNavbar.navContainer}`}>
                ...
                <div ref={ref} className="w-80 sideCart fixed top-0 right-0 bottom-0 z-10 bg-slate-800 px-8 py-10 transition-transform transform translate-x-full">
                    ...
                    <button className="flex items-center gap-2 mx-auto mt-16 text-white bg-slate-500 border-0 py-2 px-8 focus:outline-none hover:bg-slate-600 rounded text-lg"><IoBagCheck /> Checkout</button>
                </div>
            </nav>
        </>
    )
