    ...
    return (
        <>
            <nav className={`${globalNavbar.navContainer}`}>
                ...
                <div ref={ref} className="w-80 sideCart fixed top-0 right-0 bottom-0 z-10 bg-slate-500 px-8 py-10 transition-transform transform translate-x-full">
                    ...
                    <ol className='list-decimal'>
                        <li>
                            <div className='item flex my-5'>
                                ...
                                <div className='flex items-center justify-center font-semibold w-1/3'><CiCirclePlus onClick={inc} className='mx-1 text-2xl cursor-pointer' /> {count} <CiCircleMinus onClick={desc} className='mx-1 text-pink-50 text-2xl cursor-pointer' /></div>
                            </div>
                        </li>
                        <li>
                            <div className='item flex my-5'>
