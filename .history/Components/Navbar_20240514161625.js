                    ...
                    <ol className='list-decimal'>
                        <li>
                            <div className='item flex my-5'>
                                ...
                                <div className='flex items-center justify-center font-semibold w-1/3'><CiCirclePlus className='mx-1 text-2xl cursor-pointer' /> {count} <CiCircleMinus onClick={() => setCount(count-1)} className='mx-1 text-2xl cursor-pointer' /></div>
                            </div>
                        </li>
                        <li>
                            <div className='item flex my-5'>
