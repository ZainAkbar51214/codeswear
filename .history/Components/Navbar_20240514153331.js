    ...
    return (
        <>
            <nav className={`${globalNavbar.navContainer}`}>
                ...
                <div ref={ref} className="w-96 sideCart fixed top-0 right-0 bottom-0 z-10 bg-slate-400 px-2 py-10 transition-transform transform translate-x-full">
                    ...
                    <ol>
                        ...
                        <li><span className='w-1/3 bg-green-50'>1</span></li>
                    </ol>
                </div>
            </nav>
        </>
