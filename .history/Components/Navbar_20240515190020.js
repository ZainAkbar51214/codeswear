                        ...
                        {Object.keys(cart).map((k) => {
                            return <li key={k}>
                                <div className='item flex my-5'>
                                    ...
                                    <div className='flex items-center justify-center font-semibold w-1/3'><CiCircleMinus className='mx-1 text-2xl cursor-pointer' /> {cart[k].qty} <CiCirclePlus className='mx-1 text-pink-400 text-2xl cursor-pointer' /></div>
                                </div>
                            </li>
                        })}
